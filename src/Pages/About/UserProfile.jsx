...
import { FaCheckCircle, FaDownload, FaEnvelope, FaFileDownload, FaUserFriends } from 'react-icons/fa';
    ...
    return (
        <div className="bg-white dark:bg-black dark:text-white rounded-lg shadow-xl pb-8">
            ...
            <div className="flex flex-col items-center -mt-20">
                ...
                <p className="text-gray-700 dark:text-white">Junior React Web Devoloper</p>
                <p className="text-sm text-gray-500 dark:text-gray-100">Kushtia, Bangladesh</p>
            </div>
            <div className="flex-1 flex flex-col items-center lg:items-end justify-end px-8 mt-2">
                <div className="flex items-center space-x-4 mt-2">
                    <button onClick={cvDownload} className="flex items-center bg-gray-600 dark:bg-gray-100 dark:text-black hover:bg-gray-700 text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100">
                        <FaDownload className="h-4 w-4" />
                        <span>Download CV</span>
                    </button>
                    <button onClick={certificateDownload} className="flex items-center bg-gray-600 dark:bg-gray-100 dark:text-black hover:bg-gray-700 text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100">
